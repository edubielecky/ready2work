  ...
  return (
    <main className="container mt-4">
      ...
      <div className="d-flex flex-column gap-4">
        ...
        <Link to="/applications" className="glass-card summary-card" style={{'--card-index': 1}} {...glowHandlers}>
        ...
        <Link to="/performance" className="glass-card summary-card" style={{'--card-index': 2}} {...glowHandlers}>
          <span className="card-icon">🚀</span>
